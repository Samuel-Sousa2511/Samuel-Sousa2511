...
<head>
    ...
    <title>Quer namorar comigo Bia?</title>
    <style>
        body {
...
<body>
    <div class="center">
        <h1>Quer namorar comigo Bia?</h1>
    </div>
    <div class="img"></div>
    <div class="btn">
        <button id="sim"><a href="https://youtu.be/3mPmDFIlL20">Sim</a></button>
...
<!---
Samuel-Sousa2511/Samuel-Sousa2511 is a ✨ special ✨ repository because its `README.md` (this file) appears on your GitHub profile.
